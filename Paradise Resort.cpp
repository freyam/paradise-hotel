...
void HTLmenu() {
  ...
  do {
    ...
    default:
      {
        cout << "\nInvalid Choice! \nEnter any key to continue...";getch();HTLmenu();
      }
    }
  } while (response <= 5);
}
...
void room() {
  ...
  do {
    ...
    default:
      {
        cout << "\nInvalid Choice! \nEnter any key to continue...";getch();room();
      }
    }
  } while (response <= 9);
}
...
void addroom(guest g[50], int n) {
  ...
  cout << endl << "Enter the Number of Guests to be Added: ";
  cin >> x;
  cout << endl;

  for (int i = n; i < n + x; i++) {
    cout << endl << endl << "Enter the Details of the Guest #" << i + 1 << ": " << endl;
    cout << "o-------------------------------------------------------------" << endl;
    cout << "\n Name: ";
    cin >> g[i].nm;
...
void deleteroom(guest g[50], int n) {
  ...
  for (int i = 0; i < 50; i++)
    if (rmno == g[i].rmno) {
      cout << endl << "Successfully Deleted " << g[i].nm;
...
void searching() {
  ...
  do {
    ...
    default:
      {
        cout << "\nInvalid Choice! \nEnter any key to continue...";getch();searching();
      }
    }
...
void searchbyroomno(guest g[50], int n) {
  ...
  if (found == 0) cout << "Room Number " << rmno << " is Vacant or N/A!";
}
...
void searchbyname(guest g[50], int n) {
  ...
  if (found == 0) cout << "No one with this Name (" << nm << ") lives here!";
}
...
void searchbycountry(guest g[50], int n) {
  ...
  if (found == 0) cout << "Noone from " << cntry << " lives here!";
}
...
void searchbyroomtype(guest g[50], int n) {
  ...
  if (found == 0) cout << "No one lives in " << rmtyp << " Rooms!";
}
...
void sorting() {
  ...
  do {
    ...
    default:
      {
        cout << "\nInvalid Choice! \nEnter any key to continue...";getch();sorting();
      }
    }
  } while (response <= 9);
}
...
void sortbyname(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++) cout << i + 1 << ". " << g[i].nm << endl;
  cout << "o-------------------------------------------------------------" << endl;
  getch();
}
...
void sortbycountry(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++) cout << g[i].cntry << ": " << g[i].nm << endl;
  cout << "o-------------------------------------------------------------" << endl;
  getch();
}
...
void sortbyroomno(guest g[50], int n) {
  ...
  for (int i = n; i > 0; i--) cout << g[i].rmno << ": " << g[i].nm << endl;
  cout << "o-------------------------------------------------------------" << endl;
  getch();
}
...
void counting() {
  ...
  do {
    ...
    default:
      {
        cout << "\nInvalid Choice! \nEnter any key to continue...";getch();counting();
      }
    }
  } while (response <= 9);
}
...
void countbycountry(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++)
    if (strcmpi(g[i].cntry, cntry) == 0) count++;
...
void countbyroomtype(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++)
    if (strcmpi(g[i].rmtyp, rmtyp) == 0) count++;
...
void Finance() {
  ...
  do {
    ...
    default:
      {
        cout << "\nInvalid Choice! \nEnter any key to continue...";getch();Finance();
      }
    }
  } while (response <= 9);
}
  ...
  for (int i = 0; i < n; i++) {
    if (strcmpi(g[i].nm, name) == 0) {
      ...
      if (strcmpi(g[i].Bills, "NO") == 0) {
        ...
        cin >> days;
        if (strcmpi(g[i].rmtyp, "Single") == 0) net = 100 * days;
        else if (strcmpi(g[i].rmtyp, "Double") == 0) net = 200 * days;
        else if (strcmpi(g[i].rmtyp, "Queen") == 0) net = 400 * days;
        else if (strcmpi(g[i].rmtyp, "King") == 0) net = 500 * days;
        else if (strcmpi(g[i].rmtyp, "Deluxe") == 0) net = 750 * days;
        else if (strcmpi(g[i].rmtyp, "Master") == 0) net = 1000 * days;
...
void report(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++) {
    if (strcmpi(g[i].rmtyp, "SINGLE") == 0) sing++;
    if (strcmpi(g[i].rmtyp, "DOUBLE") == 0) dbl++;
    if (strcmpi(g[i].rmtyp, "QUEEN") == 0) quen++;
    if (strcmpi(g[i].rmtyp, "KING") == 0) kng++;
    if (strcmpi(g[i].rmtyp, "DELUXE") == 0) delx++;
    if (strcmpi(g[i].rmtyp, "MASTER") == 0) mstr++;
  }
  system("cls");

  cout << "#################################################################" << endl << endl;
  cout << "   ROOM TYPE      NET COST                                     " << endl << endl;
  ...
  cout << "   " << mstr << " MASTER   :    $" << 1000 * mstr << endl << endl << endl;
...
void RSTRNTmenu() {
  ...
  do {
    ...
    default:
      {
        cout << "\nInvalid Choice! \nEnter any key to continue...";getch();RSTRNTmenu();
      }
    }
  } while (response <= 2);
}
...
void orderfood(guest g[50], int n) {
  ...
  cout << endl << "Hi " << name << "! Enter the number of Food Items you would like to Order: ";
  cin >> NoOfItems;
  ...
  cout << "ORDER SUCCESSFULLY TAKEN!" << endl << endl << endl;
